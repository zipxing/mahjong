 ...
 * @LastEditTime: 2023-08-28 10:40:06
 */
            ...
            if (obs) {
                this.events[msg] = obs.filter(function (fn) {
                    if (fn.scope != scope) {
                        ...
                        LOGD("tywx.NotificationCenter", "ty.NotificationCenter : remove listener by Scope: " + msg);
                        return false;
                    }
                });
            }
...
window["tywx"] = NotificationCenter;
